...
<form method='post' id='upload_assignment_form' style='display:none' enctype="multipart/form-data">
    <input type='text' name="upload_name"><br>
    <textarea type='text' name="upload_description"></textarea><br>
    <input type='file' name="upload_file"><br>
    <input type='submit' name='upload_assignment' value='Submit'>
</form>
